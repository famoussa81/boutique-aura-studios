...
(function () {
  ...
  function products() {
    ...
    return [
      ...
      make({ id: "lv-damier", name: "Claquette Damier", brand: "louis-vuitton", price: 27000, badge: "Nouveau",
        studio: "assets/products/lv-damier-noir.webp", img: "assets/products/lv-damier-noir.webp", colors: ["Noir et gris"],
      ...
      make({ id: "lv-damier-bleu", name: "Claquette Damier Bleu", brand: "louis-vuitton", price: 27000, badge: "Nouveau",
        studio: "assets/products/lv-damier-bleu-studio-v2.webp", img: "assets/products/lv-damier-bleu-studio-v2.webp", colors: ["Bleu"],
        valueImages: { "Coloris::Bleu": "assets/products/lv-damier-bleu-studio-v2.webp" },
        stock: [2, 3, 4, 5, 3, 2, 1], desc: "Bride large à motif damier bleu et gris, montée sur une semelle bleu marine souple." }),
      ...
      make({ id: "bb-check", name: "Claquette Vintage Check", brand: "burberry", price: 27000,
        studio: "assets/products/burberry-check-beige-tan-studio.webp", img: "assets/products/burberry-check-beige-tan-studio.webp", imgs: ["assets/products/burberry-check-beige-tan-studio.webp", "assets/products/burberry-check-bordeaux-noir-studio.jpg", "assets/products/burberry-check-vert-studio.webp", "assets/products/burberry-check-bleu-studio.webp", "assets/products/burberry-check-beige-noir-studio.webp"],
      ...
      make({ id: "gv-paris", name: "Claquette Paris", audience: "homme", brand: "givenchy", price: 40000,
        studio: "assets/products/givenchy-logo-noir-studio-v3.webp", img: "assets/products/givenchy-logo-noir-studio-v3.webp", imgs: ["assets/products/givenchy-logo-noir-studio-v3.webp", "assets/products/givenchy-logo-blanc-studio-v3.webp", "assets/products/givenchy-logo-gris-studio-v3.webp", "assets/products/givenchy-logo-kaki-studio-v3.webp"],
        colors: ["Noir", "Blanc", "Gris", "Kaki"], valueImages: { "Coloris::Noir": "assets/products/givenchy-logo-noir-studio-v3.webp", "Coloris::Blanc": "assets/products/givenchy-logo-blanc-studio-v3.webp", "Coloris::Gris": "assets/products/givenchy-logo-gris-studio-v3.webp", "Coloris::Kaki": "assets/products/givenchy-logo-kaki-studio-v3.webp" },
      ...
      make({ id: "diesel-relief", name: "Claquette Relief", brand: "diesel", price: 28000,
        studio: "assets/products/diesel-relief-gris-studio.webp", img: "assets/products/diesel-relief-gris-studio.webp", imgs: ["assets/products/diesel-relief-gris-studio.webp", "assets/products/diesel-camo-clair-studio-v3.webp"], colors: ["Gris", "Camouflage clair"],
        valueImages: { "Coloris::Gris": "assets/products/diesel-relief-gris-studio.webp", "Coloris::Camouflage clair": "assets/products/diesel-camo-clair-studio-v3.webp" },
      ...
      make({ id: "gucci-stripe", name: "Claquette Bande Signature", brand: "gucci", price: 42000, badge: "Nouveau",
        studio: "assets/products/gucci-stripe-noir-studio-v2.webp", img: "assets/products/gucci-stripe-noir-studio-v2.webp", imgs: ["assets/products/gucci-stripe-noir-studio-v2.webp", "assets/products/gucci-stripe-blanc-studio.webp"], colors: ["Noir", "Blanc"],
        valueImages: { "Coloris::Noir": "assets/products/gucci-stripe-noir-studio-v2.webp", "Coloris::Blanc": "assets/products/gucci-stripe-blanc-studio.webp" },
      ...
      make({ id: "femme-coach-double-bride-rose", name: "Sandale Double Bride", audience: "femme", cat: "sandales", brand: "coach", price: 25000,
      ...
      make({ id: "femme-tory-burch-miller-pave", name: "Miller Pavé", audience: "femme", cat: "sandales", brand: "tory-burch", price: 25000, badge: "Nouveau",
        sizes: ["36", "37", "38", "39", "40", "41"], stock: [2, 3, 4, 4, 3, 2],
        img: "assets/products/femme/tory-burch-miller-pave-champagne-studio.jpg", imgs: ["assets/products/femme/tory-burch-miller-pave-champagne-studio.jpg", "assets/products/femme/tory-burch-miller-pave-argent-studio.jpg", "assets/products/femme/tory-burch-miller-pave-turquoise-studio.jpg", "assets/products/femme/tory-burch-miller-pave-lilas-studio.jpg", "assets/products/femme/tory-burch-miller-pave-noir-studio.jpg"], colors: ["Champagne", "Argent", "Turquoise", "Lilas", "Noir"],
        valueImages: { "Coloris::Champagne": "assets/products/femme/tory-burch-miller-pave-champagne-studio.jpg", "Coloris::Argent": "assets/products/femme/tory-burch-miller-pave-argent-studio.jpg", "Coloris::Turquoise": "assets/products/femme/tory-burch-miller-pave-turquoise-studio.jpg", "Coloris::Lilas": "assets/products/femme/tory-burch-miller-pave-lilas-studio.jpg", "Coloris::Noir": "assets/products/femme/tory-burch-miller-pave-noir-studio.jpg" },
        desc: "Sandale entre-doigts fine, bordée de cristaux et ornée d'un grand Double T ajouré." }),
      make({ id: "femme-fashion-fleurs", name: "Claquette Fleurs Cristal", audience: "femme", cat: "claquettes", brand: "fashion", price: 25000, badge: "Nouveau",
        sizes: ["36", "37", "38", "39", "40", "41"], stock: [2, 3, 4, 4, 3, 2],
        img: "assets/products/femme/fashion-fleurs-noir-studio.jpg", imgs: ["assets/products/femme/fashion-fleurs-noir-studio.jpg", "assets/products/femme/fashion-fleurs-rose-studio.jpg", "assets/products/femme/fashion-fleurs-ivoire-studio.jpg"], colors: ["Noir", "Rose", "Ivoire"],
        valueImages: { "Coloris::Noir": "assets/products/femme/fashion-fleurs-noir-studio.jpg", "Coloris::Rose": "assets/products/femme/fashion-fleurs-rose-studio.jpg", "Coloris::Ivoire": "assets/products/femme/fashion-fleurs-ivoire-studio.jpg" },
  ...
  function settings() {
    return {
      ...
      collections: [
        { key: "louis-vuitton", featured: true, label: "Louis Vuitton", logo: "assets/logos/louis-vuitton.png", tagline: "Monogram", accent: "#6b4f2a", cover: "assets/brand-banners/louis-vuitton.webp", homeProducts: ["lv-damier-bleu", "lv-signature", "lv-relief", "lv-v-croisee"],
...
,{ key: "coach", featured: true, label: "Coach", logo: "assets/logos/coach.svg", tagline: "Signature C", accent: "#9A6B45", cover: "assets/brand-banners/coach.jpg", homeProducts: ["coach-grand-c-signature", "coach-petit-badge-signature", "coach-matelassee", "coach-sabot-boucle"],
        ...
        ,{ key: "tory-burch", featured: true, label: "Tory Burch", logo: "", tagline: "Double T", accent: "#B99273", cover: "assets/brand-banners/tory-burch.jpg", homeProducts: ["femme-tory-burch-miller-pave", "femme-tory-burch-double-t", "femme-tory-burch-miller-jelly"],
          desc: "Double T graphique, cuir souple et jelly translucide dans une palette lumineuse." }
        ,{ key: "fashion", featured: true, label: "Fashion", logo: "", tagline: "Fleurs cristal", accent: "#C6849F", cover: "assets/brand-banners/fashion.jpg", homeProducts: ["femme-fashion-fleurs"],
