...
(function () {
  ...
  function products() {
    ...
    return [
      ...
      make({ id: "coach-slide-signature-noir", name: "Slide Signature Noir", audience: "homme", cat: "claquettes", brand: "coach", price: 0,
        sizes: ["39", "40", "41", "42", "43", "44", "45"], stock: [0, 0, 0, 0, 0, 0, 0], active: false, stockout: true,
        img: "assets/products/homme/coach-slide-signature-noir-studio.jpg", colors: ["Noir"],
        valueImages: { "Coloris::Noir": "assets/products/homme/coach-slide-signature-noir-studio.jpg" },
        desc: "Slide noir à bride en toile signature et semelle monobloc." }),
