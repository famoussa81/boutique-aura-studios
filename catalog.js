...
(function () {
  ...
  function settings() {
    return {
      ...
      collections: [
        { key: "calvin-klein", label: "Calvin Klein", logo: "assets/logos/calvin-klein.svg", tagline: "Minimalisme américain", accent: "#2E3A46", cover: "assets/marques/calvin-klein.svg",
          desc: "Le logo embossé sur bride large. Une claquette qui se reconnaît de loin." },
        { key: "louis-vuitton", featured: true, label: "Louis Vuitton", logo: "assets/logos/louis-vuitton.png", tagline: "Monogram", accent: "#6b4f2a", cover: "assets/marques/louis-vuitton.svg",
          desc: "Cuir embossé et bande signature. La pièce que tout le monde identifie." },
        { key: "hermes", featured: true, label: "Hermès", logo: "assets/logos/hermes.png", tagline: "H signature", accent: "#d86f25", cover: "assets/marques/hermes.svg",
          desc: "Cuir orange, découpe H et semelle noire. Une silhouette immédiatement reconnaissable." },
        { key: "burberry", label: "Burberry", logo: "assets/logos/burberry.png", tagline: "Vintage Check", accent: "#B08A5E", cover: "assets/marques/burberry.svg",
          desc: "Le tartan maison, décliné en trois teintes." },
        { key: "givenchy", label: "Givenchy", logo: "assets/logos/givenchy.png", tagline: "Paris", accent: "#4A3B52", cover: "assets/marques/givenchy.svg",
          desc: "L'inscription signature centrée sur la bride. Sobre et immédiat." },
        { key: "dior", label: "Dior", logo: "assets/logos/dior.svg", tagline: "Oblique", accent: "#5B6B7A", cover: "assets/marques/dior.svg",
          desc: "Toile jacquard au motif maison. La mule d'intérieur qui se porte dehors." },
        { key: "balenciaga", label: "Balenciaga", logo: "assets/logos/capture-balenciaga.png", tagline: "Mold", accent: "#111111", cover: "assets/marques/balenciaga.svg",
          desc: "Caoutchouc moulé d'une seule pièce. Une silhouette qu'on ne confond pas." },
        { key: "hugo", featured: true, label: "HUGO", logo: "assets/logos/hugo.svg", tagline: "Bande rouge", accent: "#a3262b", cover: "assets/marques/hugo.svg",
          desc: "La bande contrastée et le monogramme répété. Sport et net." },
        { key: "tommy-jeans", label: "Tommy Jeans", logo: "assets/logos/capture-tommy-jeans.png", tagline: "Flag", accent: "#1c3a6e", cover: "assets/marques/tommy-jeans.svg",
          desc: "Le drapeau tricolore en grand sur la bride." },
        { key: "moncler", label: "Moncler", logo: "assets/logos/capture-moncler.png", tagline: "Monogramme", accent: "#2F7FC4", cover: "assets/marques/moncler.svg",
          desc: "Imprimé graphique intégral, bleu et blanc." },
        { key: "ea7", label: "EA7 Emporio Armani", logo: "assets/logos/capture-ea7.png", tagline: "Sport", accent: "#5D7A8C", cover: "assets/marques/ea7.svg",
          desc: "Texture technique et logo large. Pensée pour l'été." },
        { key: "allsaints", label: "AllSaints", logo: "assets/logos/allsaints.svg", tagline: "Minimal", accent: "#6E6459", cover: "assets/marques/allsaints.svg",
