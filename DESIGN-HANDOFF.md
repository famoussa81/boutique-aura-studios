# brand-nike-325034 implementation handoff
...
- `assets/bonnet.jpg`
- `assets/cargo-beige.jpg`
- `assets/cargo-kaki.jpg`
- `assets/cargo-noir.jpg`
- `assets/cargo-street.jpg`
- `assets/collection-street.jpg`
- `assets/editorial-white.jpg`
- `assets/hero-main.jpg`
- `assets/hoodie-urbain.jpg`
- `assets/lookbook-street.jpg`
- `assets/lookbook-white.jpg`
- `assets/pants-detail.jpg`
- `assets/prod-cap.jpg`
- `assets/prod-cargo.jpg`
- `assets/prod-hoodie.jpg`
- `assets/prod-rack.jpg`
- `assets/prod-tee.jpg`
- `assets/prod-white-hoodie.jpg`
- `assets/street-brown.jpg`
- `assets/street-jacket.jpg`
- `assets/tee-duo.jpg`
- `assets/tee-oversized.jpg`
- `assets/tee-print.jpg`
- `assets/tee-vert.jpg`
- `brand.json`
- `context/input-DESIGN.md`
- `DESIGN.md`
- `GUIDE-VERCEL-SUPABASE.md`
- `guide.md`
- `imagery/cover-0.jpg`
- `imagery/cover-1.jpg`
- `imagery/cover-2.jpg`
- `imagery/cover-3.jpg`
- `logos/favicon.ico`
- `plugin-source/design-system-inspired-by-nike-generation-skill-mssa38z3/open-design.json`
- `plugin-source/design-system-inspired-by-nike-generation-skill-mssa38z3/references/provenance.json`
- `plugin-source/design-system-inspired-by-nike-generation-skill-mssa38z3/references/source-1-SKILL.md`
- `plugin-source/design-system-inspired-by-nike-generation-skill-mssa38z3/SKILL.md`
- `README.md`
- `SKILL.md`
- `supabase/schema.sql`
