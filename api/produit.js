...
module.exports = async function fiche(req, res) {
  ...
  const remplacements = [
    ...
    ['<meta property="og:image" content="https://www.tk-shoes.com/api/share-image" />',
     '<meta property="og:image" content="' + esc(photo) + '" />'],
    ['<meta property="og:url" content="https://www.tk-shoes.com/produit" />',
    ...
    ['<meta name="twitter:image" content="https://www.tk-shoes.com/api/share-image" />',
