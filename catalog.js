  ...
  function products() {
    ...
    return [
      ...
      make({ id: "ck-jeans", name: "Claquette CK Jeans", brand: "calvin-klein", price: 23000,
        img: "assets/products/ck-jeans-paire-blanc.webp", imgs: ["assets/products/ck-jeans-paire-blanc.webp", "assets/products/ck-jeans-paire-bleu.webp"], colors: ["Blanc", "Bleu"],
        valueImages: { "Coloris::Blanc": "assets/products/ck-jeans-paire-blanc.webp", "Coloris::Bleu": "assets/products/ck-jeans-paire-bleu.webp" },
      ...
      make({ id: "lv-signature", name: "Claquette Signature LV", brand: "louis-vuitton", price: 45000,
        img: "assets/products/lv-signature-paire-bleu.webp", imgs: ["assets/products/lv-signature-paire-bleu.webp", "assets/products/lv-signature-paire-noir.webp", "assets/products/lv-signature-paire-marron.webp"],
        colors: ["Bleu", "Noir", "Marron"], valueImages: { "Coloris::Bleu": "assets/products/lv-signature-paire-bleu.webp", "Coloris::Noir": "assets/products/lv-signature-paire-noir.webp", "Coloris::Marron": "assets/products/lv-signature-paire-marron.webp" },
      ...
      make({ id: "bb-check", name: "Claquette Vintage Check", brand: "burberry", price: 38000,
        img: "assets/products/burberry-check-beige.webp", imgs: ["assets/products/burberry-check-beige.webp", "assets/products/burberry-check-vert.webp", "assets/products/burberry-check-paire-bleu-ciel.webp", "assets/products/burberry-check-paire-noir.webp"],
        colors: ["Beige", "Vert", "Bleu ciel", "Noir"], valueImages: { "Coloris::Beige": "assets/products/burberry-check-beige.webp", "Coloris::Vert": "assets/products/burberry-check-vert.webp", "Coloris::Bleu ciel": "assets/products/burberry-check-paire-bleu-ciel.webp", "Coloris::Noir": "assets/products/burberry-check-paire-noir.webp" },
      ...
      make({ id: "gv-paris", name: "Claquette Paris", brand: "givenchy", price: 40000,
        img: "assets/products/givenchy-paris-blanc.webp", imgs: ["assets/products/givenchy-paris-blanc.webp", "assets/products/givenchy-paris-noir.webp", "assets/products/givenchy-paris-paire-bleu.webp", "assets/products/givenchy-paris-paire-beige.webp"],
        colors: ["Blanc", "Noir", "Bleu", "Beige"], valueImages: { "Coloris::Blanc": "assets/products/givenchy-paris-blanc.webp", "Coloris::Noir": "assets/products/givenchy-paris-noir.webp", "Coloris::Bleu": "assets/products/givenchy-paris-paire-bleu.webp", "Coloris::Beige": "assets/products/givenchy-paris-paire-beige.webp" },
      ...
      make({ id: "dr-oblique", name: "Mule Oblique", cat: "mules", brand: "dior", price: 48000,
        img: "assets/products/dior-oblique-paire-noir.webp", imgs: ["assets/products/dior-oblique-paire-noir.webp", "assets/products/dior-oblique-paire-gris.webp"], colors: ["Noir", "Gris"],
        valueImages: { "Coloris::Noir": "assets/products/dior-oblique-paire-noir.webp", "Coloris::Gris": "assets/products/dior-oblique-paire-gris.webp" },
      ...
      make({ id: "hg-mono", name: "Claquette Monogramme", brand: "hugo", price: 24000,
        img: "assets/products/hugo-monogramme-noir.webp", imgs: ["assets/products/hugo-monogramme-noir.webp", "assets/products/hugo-monogramme-paire-bleu-blanc.webp"],
        colors: ["Noir", "Bleu et blanc"], valueImages: { "Coloris::Noir": "assets/products/hugo-monogramme-noir.webp", "Coloris::Bleu et blanc": "assets/products/hugo-monogramme-paire-bleu-blanc.webp" },
      ...
      make({ id: "ea-logo", name: "Claquette Logo", brand: "ea7", price: 21000,
        img: "assets/products/ea7-logo-paire-noir.webp", imgs: ["assets/products/ea7-logo-paire-noir.webp", "assets/products/ea7-logo-paire-beige.webp"], colors: ["Noir", "Beige"],
        valueImages: { "Coloris::Noir": "assets/products/ea7-logo-paire-noir.webp", "Coloris::Beige": "assets/products/ea7-logo-paire-beige.webp" },
